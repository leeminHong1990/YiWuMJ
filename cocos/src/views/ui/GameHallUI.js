...
var GameHallUI = UIBase.extend({
    ...
    init_function_panel:function(){
        ...
        if ((cc.sys.os == cc.sys.OS_IOS && cc.sys.isNative) && switches.appstore_check == true) {
            function_panel.getChildByName("notice_btn").setVisible(false);
            function_panel.getChildByName("customerservice_btn").setVisible(false);

            function_panel.getChildByName("score_btn").setPositionX(function_panel.getContentSize().width * 0.25);
            function_panel.getChildByName("intro_btn").setPositionX(function_panel.getContentSize().width * 0.50);
            function_panel.getChildByName("config_btn").setPositionX(function_panel.getContentSize().width * 0.75);
		}
	},
    ...
    init_game_panel:function(){
        ...
        if ((cc.sys.os == cc.sys.OS_IOS && cc.sys.isNative) && switches.appstore_check == true) {
            create_club_btn.setVisible(false);
            join_club_btn.setVisible(false);
            create_room_btn.setPositionX(game_panel.getContentSize().width  * 0.3);
            join_room_btn.setPositionX(game_panel.getContentSize().width * 0.7);
        }
    },
});